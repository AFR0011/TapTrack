...
- 2026-09-05 | TT-B001 CI-1 | `RESOLVED` | Push and pull-request runs reached the Playwright
  ...
  both viewport projects pass locally, and replacement push/PR CI runs passed.
